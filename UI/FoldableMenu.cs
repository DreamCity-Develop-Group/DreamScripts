...
namespace Assets.Scripts.UI
{
    ...
    public class FoldableMenu : MonoBehaviour
    {
        ...
        void Init()
        {
            ...
            textAsset = Resources.Load<TextAsset>("Mail/menuInfo");

            parentRect = Resources.Load<RectTransform>("Mail/parentMenu");
            parentOffset = new Vector3(0, parentRect.rect.height);

            childRect = Resources.Load<RectTransform>("Mail/ItemMenu");
